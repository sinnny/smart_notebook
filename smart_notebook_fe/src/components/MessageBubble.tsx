        ...
        >
          {isUser ? (
            <div>
              ...
              {hasTranslation && (
                <div className="mt-2.5 pt-2.5 border-t border-white/20">
                  ...
                  <p className="whitespace-pre-wrap leading-relaxed opacity-90 break-words">
            ...
            <div className="px-1 py-1 overflow-hidden w-full max-w-full">
              <div
                className="prose prose-sm max-w-full break-words overflow-x-hidden 
                  ...
                  components={{
                    ...
                    code({ node, inline, className, children, ...props }: any) {
                      ...
                      return !inline && match ? (
                        ...
                        <code
                          className="text-[13px] text-blue-600 bg-blue-50 px-1.5 py-0.5 rounded font-mono before:content-[''] after:content-['']"
                          {...props}
                        >
                          {children}
                        </code>
